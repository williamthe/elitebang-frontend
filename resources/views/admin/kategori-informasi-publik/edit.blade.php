        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap pl-0">
                <div class="col-md-12 pr-5 mr-2">
                    ...
                    <span class="nav-text bold ml-5">Jenis Pelayanan Incubator - Edit Data</span>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Jenis :</label>
                                        {{ Form::select('jenis',$jenis,$data['jenis'], ['title' => 'Pilih Jenis','class' => 'form-control selectpicker', 'id' => 'kelitngan_lingkup_add', 'data-size' => '7', 'data-live-search' => 'true', 'data-toggle'=>'ajax']) }}
                                    </div>
                                    <div class="col-lg-6">
    ...
    <script>
        ...
        $('#btn_agenda_edit_data').click(function(){
            ...
            $.ajax({
                type: "POST",
                timeout: 50000,
                url: '/kategori-informasi-publik-update',
                async: true,
                data: {
