...
{{--                    <ul class="nav nav-light-primary nav-pills tabs-unlimited" id="menu_tab" role="tablist"></ul>--}}
                    <span class="nav-text bold ml-5">Surat Rekomendasi - Index</span>
                </div>
            </div>
        </div>
...
{{--                                                                class="flaticon2-plus mr-n1"></i></a>--}}
{{--                                                    </div>--}}
    ...
    <script>
        ...
        function filterTanggal() {
            ...
            indexAgenda = $(`#tbl_kelitbangan`).DataTable({
                ...
                ajax: {
                    type:'POST',
                    url: '/surat-rekomendasi-list-tanggal',
                    async: true,
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        //type: "POST",
                        timeout: 50000,
                        url: '/surat-rekomendasi-delete/'+id,
                        async: true,
