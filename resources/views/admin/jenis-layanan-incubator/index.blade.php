...
{{--                    <ul class="nav nav-light-primary nav-pills tabs-unlimited" id="menu_tab" role="tablist"></ul>--}}
                    <span class="nav-text bold ml-5">Jenis Layanan Incubator - Index</span>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 ml-auto my-md-0">
                                                <div class="d-flex flex-row-reverse">
                                                    <div class="ml-2"><a href="/jenis-layanan-incubator-tambah" class="btn btn-light-primary btn-sm"
    ...
    <script>
        ...
        function resetData() {
            indexAgenda = $(`#tbl_kelitbangan`).DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/jenis-layanan-incubator-list',
                    async: true,
                    error: function (res) {
